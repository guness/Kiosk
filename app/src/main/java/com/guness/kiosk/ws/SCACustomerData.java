...
public class SCACustomerData extends AttributeContainer implements KvmSerializable
{
    ...
    public SCACustomerData ()
    {
    }

    public SCACustomerData (Object paramObj,SCAExtendedSoapSerializationEnvelope __envelope)
    {
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        if(propertyIndex==0)
        {
            ...
            info.name = "Firstname";
            info.namespace= "http://schemas.datacontract.org/2004/07/F2M.Api.Soap.CardService.Contracts.Response.Customer";
        }
        if(propertyIndex==1)
        {
            info.type = PropertyInfo.STRING_CLASS;
